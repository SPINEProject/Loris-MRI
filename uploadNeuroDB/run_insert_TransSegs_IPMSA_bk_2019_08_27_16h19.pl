...
my $tref;
my $tref_desc = "Transfomation reference";
my $verbose          = 0;
...
if (!defined $tref) {
    print $Help;
    print STDERR "$Usage\n\tERROR: You must specify a transformation reference.\n\n";
    # AMP - Exit codes were not located
    #exit $NeuroDB::ExitCodes::PROFILE_FAILURE;
    print "NeuroDB::ExitCodes::TREF_NOT_SPECIFIED\n\n";
    exit 105;
    # PMA
}
